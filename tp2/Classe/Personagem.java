...
Úlitma atualização: 14/04/2024
Objetivo: Crie uma classe Personagem seguindo todas as regras apresentadas no slide unidade01g_conceitosBasicos_introducaoOO.pdf
*/
public class Personagem {
  ...
  public static boolean sequentialSearch(Personagem[] Personagens, int quant, String nome) {
    boolean achou = false;
    for (int i = 0; i < quant; i++) {
      comp++;
      if (Personagens[i].name.equals(nome)) {
        achou = true;
        break;
      }
    }
